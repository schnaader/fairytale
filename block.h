...
public:
  ...
  Block* segmentAround(const off_t pos, const int64_t size, Stream* childStream, void* blInfo, const size_t sizeInfo, const BlockType newType, const bool childDone = false, const BlockType childType = BlockType::DEFAULT);
